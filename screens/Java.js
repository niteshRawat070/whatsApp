    ...
    return (
        <ScrollView>
            <View style={{height:windowHeight-100,justifyContent:'space-between'}}>
              <View>
                  <ScrollView>
              <MyRow mes={details.chats[0].messages[0].message} tim={details.chats[0].messages[0].time}/>
              <PartnerRow name={details.chats[0].messages[1].from} mes={details.chats[0].messages[1].message} tim={details.chats[0].messages[0].time} />
              <MyRow mes={details.chats[0].messages[2].message} tim={details.chats[0].messages[2].time}/>
              {list.map(data=>(
