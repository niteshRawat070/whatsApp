    ...
    return (
        <ScrollView>
            <View style={{height:windowHeight-100,justifyContent:'space-between'}}>
              <View>
                  <ScrollView>
              <MyRow mes={details.chats[1].messages[0].message} tim={details.chats[1].messages[0].time}/>
              <PartnerRow name={details.chats[1].messages[1].from} mes={details.chats[1].messages[1].message} tim={details.chats[1].messages[0].time} />
              {list.map(data=>(
